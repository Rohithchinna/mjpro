...
class NetworkConsumer(AsyncWebsocketConsumer):
    ...
    async def send_notification(self, event):
        ...
        await sync_to_async(Notification.objects.create)(notif_from_user=get_instance_sender,is_seen=False,notif_content=type,notif_to_user=get_instance_receiver)
